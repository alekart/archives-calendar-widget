...
class OptionsExample extends _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Component {
  constructor() {
    super(...arguments);
    this.state = {
      exampleText: '',
  ...
  componentDidMount() {
    _wordpress_api__WEBPACK_IMPORTED_MODULE_4___default().loadPromise.then(() => {
      this.settings = new (_wordpress_api__WEBPACK_IMPORTED_MODULE_4___default().models).Settings();
      const {
        isAPILoaded
      } = this.state;
  ...
  render() {
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.Panel, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.PanelBody, {
      title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Example Meta Box', 'wholesome-plugin'),
      icon: "admin-plugins"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.TextControl, {
      help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('This is an example text field.', 'wholesome-plugin'),
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Example Text', 'wholesome-plugin'),
      onChange: exampleText => this.setState({
        exampleText
      }),
      value: exampleText
    })));
...
function Edit(props) {
  ...
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(OptionsExample, {
    ...props
  }));
}
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_5__.name, {
  ...
  // Render the block's content on the server
  // This function is called when the block is rendered on the server
  // and should return the block's content as a string
  // The block's attributes are passed as the second argument
  // and can be used to generate the block's content
  // In this example, the block's content is generated using the exampleText attribute
  // but you can use any data source to generate the content
  // such as a database or an API
  // Note that this function is only called when the block is rendered on the server
  // and not when it is rendered on the client
  render: ({
    attributes
  }) => {
    const {
...
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"arcw/arcw","version":"2.0.0","title":"Archives Calendar 2","category":"widgets","icon":"calendar","description":"Example block scaffolded with Create Block tool.","example":{},"supports":{"html":false},"textdomain":"arcw","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","render":"file:./render.php","viewScript":"file:./view.js"}');
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkarcw"] = self["webpackChunkarcw"] || [];
